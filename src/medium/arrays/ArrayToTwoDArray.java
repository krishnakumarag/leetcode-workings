...
/**
 * Refer - https://leetcode.com/problems/convert-an-array-into-a-2d-array-with-conditions/description/
 */
public class ArrayToTwoDArray {
    ...
    public static void main(String[] args) {
        System.out.println(new ArrayToTwoDArray().findMatrix(new int[]{1,3,4,1,2,3,1}));
    }
}
